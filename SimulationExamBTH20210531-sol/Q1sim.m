function [N,Tm,T,ro]=Q1sim(lambda,mu,endtime)

% N is number of customers in the system in measured time
%Tm is the sojourn time of customers in the system in measured time
%T is the sjourn time of all cusotomers (without consideration of measured
%time)
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
t=0; %current time
...
while t<endtime
    ...
    elseif nextevent==2
        ...
        Tm(nbrmeasurements)=timeinsystem;
